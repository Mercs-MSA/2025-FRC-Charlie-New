...
public class CommandIntakeOutNoBeamBreak extends Command {
    private final IntakeFlywheels m_intakeFlywheels;
    private final IntakeBeambreak m_breambreak;

    private double voltage;

    public CommandIntakeOutNoBeamBreak(IntakeFlywheels m_intakeFlywheels, IntakeBeambreak m_beambreak, double voltage) {
